...
public class UploadTest {
    ...
    public Map<String,String> uploadTest(@RequestParam("file") MultipartFile file, @RequestParam String SavePath, @RequestParam int id)
        ...
        try {
            ...
            String returnPath = "D:\\IdeaRepository\\HdyFitness-master\\fitness-server\\video\\returnedVideo\\"  + returnedVideoName;


            if (id == 1) {
                String commandStr = "cmd /c build\\bin\\OpenPoseDemo.exe --video " + videoPath + " --write_video " + returnPath;
                System.out.println(commandStr);
                File dir = new File("D:\\GraduateDesign\\openpose");
                exeCmd(commandStr, dir);
            }
            if (id == 2) {
                String commandStr = "cmd /c python D:\\GraduateDesign\\openpose\\build\\bin\\test\\fwc.py -i " + videoPath + " -o " + returnPath;
                System.out.println(commandStr);
                exeCmd(commandStr, null);
            }
            if (id == 3) {
                String commandStr = "cmd /c python D:\\GraduateDesign\\openpose\\build\\bin\\test\\ytxs.py -i " + videoPath + " -o " + returnPath;
                System.out.println(commandStr);
                exeCmd(commandStr, null);
            }
            if (id == 7) {
                String commandStr = "cmd /c python D:\\GraduateDesign\\openpose\\build\\bin\\test\\ywqz.py -i " + videoPath + " -o " + returnPath;
                System.out.println(commandStr);
                exeCmd(commandStr, null);
            }
            if (id == 8) {
                String commandStr = "cmd /c python D:\\GraduateDesign\\openpose\\build\\bin\\test\\sd.py -i " + videoPath + " -o " + returnPath;
                System.out.println(commandStr);
                exeCmd(commandStr, null);
            }
            if (id == 4) {
                String commandStr = "cmd /c python D:\\GraduateDesign\\openpose\\build\\bin\\test\\ytxspj.py -i " + videoPath + " -o " + returnPath;
                System.out.println(commandStr);
                exeCmd(commandStr, null);
            }if (id == 5) {
                String commandStr = "cmd /c python D:\\GraduateDesign\\openpose\\build\\bin\\test\\fwcpj.py -i " + videoPath + " -o " + returnPath;
                System.out.println(commandStr);
                exeCmd(commandStr, null);
            }
            ...
            //avi转mp4
            String targetPath = "D:\\IdeaRepository\\HdyFitness-master\\fitness-server\\video\\avi_mp4\\"+pikId + "_" + fileName + "."+"mp4";
            System.out.println(targetPath);
            String commandStr2 = "cmd /c ffmpeg -loglevel quiet -i " + returnPath + " -b:v 0 " + targetPath;
    ...
    public void test1() {
        File dir = new File( "D:\\GraduateDesign\\openpose");
        String commandStr = "cmd /c python D:\\GraduateDesign\\openpose\\build\\bin\\test\\fwc.py -i E:/Desktop/fwc1.mp4 -o E:/Desktop/hdy.avi";
        exeCmd(commandStr,null);
    }
}
