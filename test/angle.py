...
try:
    ...
    try:
        ...
        if platform == "win32":
            ...
            sys.path.append('E:\Desktop\openpose-1.6.0\openpose-1.6.0/build/bin');
    ...
    parser.add_argument("--image_dir", default="E:\Desktop\openpose-1.6.0\openpose-1.6.0/build/bin\media",
    ...
    params = dict()
    params["model_folder"] = "E:\Desktop\openpose-1.6.0\openpose-1.6.0\models"
